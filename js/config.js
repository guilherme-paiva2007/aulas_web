...
HTMLs.provisoreButtons.value = `
                <select name="mainColorSelector" onchange="processValue(value => theme.color.set(value))">
...
HTMLs.headerMenuIcon = new patternElement('headerMenuIcon', 'id', 'before')
...
HTMLs.headerConfigIcon = new patternElement('headerConfigIcon', 'id', 'before')
